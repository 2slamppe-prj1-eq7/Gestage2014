...
for ($i = 0; $i <=1; $i++) {
    ...
    $sql="INSERT INTO `gestage`.`SPECIALITE` (
    `IDSPECIALITE` ,
...
$listeNom = array('BOITIVEAU','BRETIN','BUREAU','CHAPRENTIER','CHARRIAU','CUNIBERTI','DION','DROUAUD','DURAND','DURET','FERRE','GOURLAOUEN','HAMON','HASTINGS','LEMONNIER','LEPEE','LE MONNIER','LOISEAU','MABILEAU','MACHOURI','MARCOUYOUX','MORNET','PARISOT','PERROIN','POIRSON','RADOJKOVIC','REDOR','SALARDAINE','THIBEAU','TOUCHARD','TREMION');
